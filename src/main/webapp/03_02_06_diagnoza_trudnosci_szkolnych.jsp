        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Diagnoza trudności szkolnych i dysleksji</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
								...
								src="./graphics/fotolia/03_02_06_diagnoza_trudnosci_szkolnych_563_375.jpg" 
														alt="">
                    <!-- Indicators 
            ...
            <div class="col-md-6">
                <h3>Diagnoza trudności szkolnych i dysleksji</h3>
								<p style="text-align:justify">
Poradnia oferuje diagnozę trudności szkolnych i dysleksji - 
jako że każdego małego pacjenta traktujemy indywidualnie,
zapraszamy do bezpośredniego 
<a href="07_kontakt.jsp">kontaktu.</a><br><br>
