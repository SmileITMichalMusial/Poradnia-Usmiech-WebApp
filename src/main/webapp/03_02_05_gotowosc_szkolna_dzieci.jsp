...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Gotowość szkolna</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <h3>Gotowość szkolna</h3>
								<p style="text-align:justify">
Poradnia oferuje diagnozę gotowości szkolnej - 
jako że każdego małego pacjenta traktujemy indywidualnie, zapraszamy do bezpośredniego 
