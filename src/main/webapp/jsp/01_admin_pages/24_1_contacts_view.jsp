...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-10 col-md-10 col-sm-10">
            ...
            <a href="/jsp/01_admin_pages/22_3_add_employee.jsp" class="btn btn-default">Dodaj kontakt <i
            ...
            <div class="table-responsive table-bordered table-striped table-hover table-condensed">
                <table class="table-responsive table-bordered table-striped table-hover table-condensed">
                    ...
                    <c:forEach items="${listOfContacts}" var="contactLoop">
                        <tr>
                            <td>
                                <a href="/ContactViewServlet?id=${contactLoop.getId()}"><em
                                        class="fa fa-newspaper-o color-aqua"></em></a>
                            </td>
                            <td>
                                <a href="/ContactEditServlet?id=${contactLoop.getId()}"><em
                                        class="fa fa-pencil color-aqua"></em></a>
                            </td>
                            <td>
                                <c:if test="${!contactLoop.getActive()}">
                                    <p class="text-muted">
                                            ${contactLoop.getId()}
                                    </p>
                                </c:if>
                            ...
                            <td>
                                ...
                                <c:if test="${contactLoop.getActive()}">Tak</c:if>
                                <c:if test="${!contactLoop.getActive()}"><p class="text-muted">Nie</p></c:if>

                            </td>
                            <td>
                                <c:set var="active" scope="session"
                                       value="${contactLoop.getActive()}"/>
                                <c:if test="${active}">
                                    <a href="/ContactDeleteServlet?id=${contactLoop.getId()}"><em
