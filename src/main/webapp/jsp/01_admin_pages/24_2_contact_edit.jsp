...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-10 col-md-10 col-sm-10">
            <h4>Edycja kontaktu</h4>
            <br>



            <form class="form-wrapper" method="post" action="/ContactEditServlet" enctype="multipart/form-data">

                Ulica: <input type="text" class="form-control" name="street" placeholder="ulica"
                             value="${contact.getStreet()}" required>
                Kod pocztowy: <input type="text" class="form-control" name="postcode" placeholder="kod pocztowy"
                                 value="${contact.getPostcode()}" required>
                Miasto: <input type="text" class="form-control" name="city" placeholder="miasto"
                                      value="${contact.getCity()}" required>

                Telefon: <input type="tel" class="form-control" name="phone" placeholder="telefon"
                                value="${contact.getPhone()}">
                Email: <input type="email" class="form-control" name="email" placeholder="email"
                              value="${contact.getEmail()}" required>

                <button type="submit" name="save" class="btn btn-default">Zaktualizuj <i
                        class="fa fa-save"></i></button>
                <a href="/jsp/01_admin_pages/24_1_contacts_view.jsp" class="btn btn-default">Anuluj<i
