        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Terapia ręki</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
								<img class="img-responsive" src="graphics/fotolia/03_02_04_terapia_reki_dzieci_563_375.jpg"
														alt="">
                    <!-- Indicators 
...
ma na celu usprawnianie tzw. małej motoryki, 
czyli precyzyjnych ruchów dłoni i palców. <br /><br />
Zajęcia służą przede wszystkim do poprawy samodzielności w podstawowych czynnościach życia codziennego 
(wiązanie butów, zapinanie guzików, lepienie z plasteliny) 
jak również dostarczania bodźców dotykowych, poznawania i rozróżniania kształtów i struktur materiałów. <br /><br />
Zajęcia poprawiają i wzmacniają koordynację wzrokowo-ruchową dzieci.
</p>
Celem zajeć jest:
<ul>
  <li>poprawa umiejętnośći chwytania</li>
  <li>wspomaganie precyzyjnych ruchów rąk</li>
  <li>wzmacnianie koncentracji</li>
  <li>poprawę koordynacji wzrokowo-ruchowej</li>
</ul>
<p style="text-align:justify">
Czas trwania zajęć i cena jest ustalana indywidulanie i dostosowana do możliwości dziecka.
<br><br>
