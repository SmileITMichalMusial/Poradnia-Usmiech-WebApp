...
<head>
    <meta name="google-site-verification" content="OZgbffyqRFksDz0M5b9lqblRzARLp0nBKhYsJeK7T2Y"/>
    <meta charset="utf-8">
...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><br>
                <center>Witamy na stronie Poradni Psychologicznej "Uśmiech"
                </center>
            </h1>
        </div>
        <div class="col-md-4">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4><i class="fa fa-fw fa-check"></i>O Poradni</h4>
                </div>
        ...
        <div class="col-md-4">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4><i class="fa fa-fw fa-gift"></i>Nasza oferta</h4>
                </div>
                <div class="panel-body">
        ...
        <div class="col-md-4">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4><i class="fa fa-fw fa-compass"></i>Cennik</h4>
                </div>
                <div class="panel-body">
    ...
    <div class="row">
        <div class="col-lg-12">
            <br>
            <h2 class="page-header">
                <center>Oferta Poradni Psychologicznej "Uśmiech"</center>
            </h2>
        </div>
        <div class="col-md-6"><br><br>
            <p>W ofercie poradni znajdą Państwo m.in.:</p>
            <ul>
                <li>diagnoza i terapia logopedyczna</li>
                <li>diagnoza i terapia psychologiczna</li>
                <li>terapia ręki</li>
                <li>badanie gotowości szkolnej</li>
                <li>diagnoza trudności szkolnych i dyslesji</li>
                <li>mediacja par i rodzin</li>
                <li>konsultacje dietetyczne</li>
                <li>warsztaty inteligencji emocjonalnej</li>
                <li>trening umiejętności społecznych</li>
                <li>warsztaty umiejętności wychowawczych</li>
                <li><strong>kompleksowa obsługa psychologiczno-logopedyczna przedszkoli</strong></li>

            </ul>

        </div>
        <div class="col-md-6"> <!-- stare ./graphics/00_07_index_logo_270_258.jpg" -->
            <img class="img-responsive" src="./graphics/00_07_index_logo.png" alt="">
        </div>
    </div>
    <!-- /.row -->
    ...
    <div class="well">
        <div class="row">
            <div class="col-md-8">
                <p>Serdecznie zapraszamy do zapoznania się z treścią strony Poradni Psychologicznej "Uśmiech",
    ...
    <hr>
    <div class="col-lg-12">
        <center>Akceptujemy płatności kartą i zbliżeniowe:</center>
        <center><img border="0" width=60% src="./graphics/00_08_platnosc_zblizeniowa_podluzne.jpg" alt=""></center>
        <hr>
    </div>
    <br>
