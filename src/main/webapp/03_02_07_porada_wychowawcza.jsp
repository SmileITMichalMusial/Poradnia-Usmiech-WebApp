    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Porada wychowawcza</li>
            </ol>
        </div>
    </div>
    <!-- /.row -->
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                <img class="img-responsive"
                     src="graphics/old/03_02_07_porada_wychowawcza_563_375.jpg"
                     alt="">
                <!-- Indicators
        ...
        <div class="col-md-6">
            ...
            <p style="text-align:justify">
                Porada wychowawcza to okazja dla rodziców na jednorazowe spotkanie z psychologiem w gabinecie. Celem
                jest uzyskanie porady dotyczącej nurtującego rodziców problemu związanego z rozwojem/zachowaniem
                dziecka.

                <br><br>
                Jeśli wspólnie z psychologiem rodzice dojdą do wniosku, że jedno spotkanie to za mało, aby nastąpiła
                oczekiwana zmiana, moga wrócić pracy z psychologiem w trybie konsultacji osób dorosłych.
                Zapisanie pytań do psychologa przed wizytą ułatwi szybkie przedstawienie sytuacji specjaliście.
                <br><br>
                W celu umówienia spotkania zapraszamy do <a href="07_kontakt.jsp">kontaktu.</a><br><br>
                Nasz cennik znajduje się <a href="06_cennik.jsp">tutaj</a>.
            </p>
        </div>
